...
deeplabcut.convert_detections2tracklets(config,[videopath],videotype='.mp4',shuffle=shuffle,trainingsetindex=trainingsetindex, destfolder=destfolder,modelprefix=modelprefix,edgewisecondition=edgewisecondition)
