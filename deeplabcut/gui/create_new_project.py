...
#        self.sizer.Add(line, pos=(3, 0), span=(1, 8),flag=wx.EXPAND|wx.BOTTOM, border=10)
        ...
        self.sizer.Add(self.proj_name_txt_box, pos=(4, 1),span=(1, 5), flag=wx.TOP|wx.EXPAND)
        ...
        self.sizer.Add(self.exp_txt_box, pos=(5, 1),span=(1, 5), flag=wx.TOP|wx.EXPAND,border=5)
