...
```{hint}
💡📚 If you are new to Python and DeepLabCut, you might consider checking our {ref}`beginner guide <file:beginners-guide>` once you are ready to jump into using the DeepLabCut App!
```
