...
def _video_inference_superanimal(
    ...
    superanimal_name: str
        The name of the superanimal model. We currently only support "superanimal_quadruped", "superanimal_topviewmouse", "superanimal_superbird", and "superanimal_humanbody"
    scale_list: list
