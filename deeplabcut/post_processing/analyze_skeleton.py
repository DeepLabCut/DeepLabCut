...
# MAIN FUNC
def analyzeskeleton(config, video, videotype='avi', shuffle=1, trainingsetindex=0, save_as_csv=False, destfolder=None):
	"""
	...
	# Get skeleton bodyparts
	skeleton_bps = cfg['skeleton']
