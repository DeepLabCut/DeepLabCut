...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  2 13:56:11 2019
@author: alex
...
task='TEST1' # Enter the name of your experiment Task
...
task='TESTmultianimal' # Enter the name of your experiment Task
scorer='Alex' # Enter the name of the experimenter/labeler
...
deeplabcut.extract_outlier_frames(config,['/home/alex/Dropbox/InterestingCode/social_datasets/4tanmay/silversideschooling-Valentina-2019-07-14/videos/deeplc.menidia.feeding.school3.176pm.S04.D.short.avi'],shuffle=0,outlieralgorithm='jump',epsilon=5)
#NOTE: commented out some bodyparts in config.yaml (as I did not do inference for all)
#deeplabcut.refine_labels(config)

#config='/home/alex/Dropbox/InterestingCode/social_datasets/croppeddatasets/silversideschooling-Valentina-2019-07-14/config.yaml'
...
#config='/home/alex/Dropbox/InterestingCode/social_datasets/croppeddatasets/escaping-souvik-2019-09-25/config.yaml'
#deeplabcut.cropimagesandlabels(config,userfeedback=False)
