...
CUDA_VISIBLE_DEVICES=0 python3 AnalyzeVideosAndExtractScoreMaps.py
...
for video in videos:
    ...
    try:
        ...
        for index in tqdm(range(nframes_approx)):
            ...
            Data[index]={}
            Data[index]['scmap']=scmap
            Data[index]['locref']=locref
        ...
        metadata = {'data': dictionary, 'scoremapsandlocref': Data}
