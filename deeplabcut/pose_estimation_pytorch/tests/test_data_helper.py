...
def test_propertymeta_project(repo_path):
    project_root = os.path.join(
        repo_path, 'examples', 'openfield-Pranav-2018-10-30',
    )
...
@pytest.mark.parametrize('repo_path, mode', [('/home/anastasiia/DLCdev', 'train'), ('/home/anastasiia/DLCdev', 'test')])
...
@pytest.mark.parametrize(
    'list_dicts, keys_to_include', [
        ...
        (
            [
                *[{
                    'keypoints': np.random.randn(27, 3), 'images': np.random.randn(
                        256, 192,
                    ),
                }]*10,
            ], [*['keypoints', 'images']*10],
