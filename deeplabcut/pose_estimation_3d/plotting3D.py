    ...
    for bpindex,bp in enumerate(bodyparts2plot):
        ...
        if (df_cam1_view[scorer_cam1][bp]['likelihood'].values[k]) > pcutoff and (df_cam2_view[scorer_cam2][bp]['likelihood'].values[k]) > pcutoff:
            if trailpoints > 0:
                ...
                xdata_cam2.append(df_cam2_view.iloc[max(0,k-trailpoints):k][scorer_cam1][bp]['x'])
                ydata_cam2.append(df_cam2_view.iloc[max(0,k-trailpoints):k][scorer_cam1][bp]['y'])
                ...
                xdata_cam2.append(df_cam2_view.iloc[k][scorer_cam1][bp]['x'])
                ydata_cam2.append(df_cam2_view.iloc[k][scorer_cam1][bp]['y'])
