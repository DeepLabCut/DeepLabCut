...
import copy
from .backbones.vit_pytorch import vit_base_patch16_224_TransReID, vit_small_patch16_224_TransReID, deit_small_patch16_224_TransReID, dlc_base_kpt_TransReID
...
class build_dlc_transformer(nn.Module):
    def __init__(self, cfg, kpt_num, factory):
        ...
        self.base = factory['dlc_transreid'](sie_xishu=cfg.MODEL.SIE_COE,
