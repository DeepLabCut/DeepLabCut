...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='/data/eccv_posedata/data/daniel3mouse_val_bbox_AP16.json',
)
...
data_root = '/data/eccv_posedata/data/daniel3mouse'
dataset_info = '/data/eccv_posedata/data/all_topview_70-D-O/dataset.json'
