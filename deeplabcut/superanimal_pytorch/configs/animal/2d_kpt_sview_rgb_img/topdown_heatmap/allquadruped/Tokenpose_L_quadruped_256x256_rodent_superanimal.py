...
model = dict(
    ...
    keypoint_head=dict(
        ...
        loss_keypoint=dict(type='JointsMSELoss', use_target_weight=True, gradient_masking = False)),
    train_cfg=dict(),
    test_cfg=dict(
        flip_test=False,
...
data_root = 'data/rodent_superanimal/'
dataset_info = 'data/rodent_superanimal/dataset.json'
