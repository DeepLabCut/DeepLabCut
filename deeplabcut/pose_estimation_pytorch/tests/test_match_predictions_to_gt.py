...
def test_invalid_rmse(animals_and_keypoints_invalid:tuple)->None:
    ...
    with pytest.raises(ValueError):
        deeplabcut_torch_match_predictions_gt.rmse_match_prediction_to_gt(pred_kpts,gt_kpts,indv_names)
...
def test_rmse_match_predictions_to_gt(animals_and_keypoints:tuple, num_animals:int=6)->None:
    ...
    col_ind = deeplabcut_torch_match_predictions_gt.rmse_match_prediction_to_gt(pred_kpts,gt_kpts,indv_names)
