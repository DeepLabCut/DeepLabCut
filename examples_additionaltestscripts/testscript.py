...
edits = {"save_iters": numiter, "display_iters": 2, "multi_step": [[0.001, numiter]]}
...
deeplabcut.create_labeled_video(
    path_config_file, [newvideo], destfolder=dfolder, displaycropped=True, filtered=True
)
deeplabcut.plot_trajectories(
    path_config_file, [newvideo], destfolder=dfolder, filtered=True
)
...
print("CHANGING training parameters to end quickly!")
edits = {"save_iters": 10, "display_iters": 2, "multi_step": [[0.001, 10]]}
DLC_config = deeplabcut.auxiliaryfunctions.edit_config(posefile, edits)
