...
def parse_args():
    ...
    parser.add_argument("--only_train_head", action="store_true", default=False)
...
def main():
    ...
    # try freezing params for non se
    if cfg.get("only_train_head", False):
        for name, param in model.named_parameters():
            if "keypoint_head" not in name:
