...
We replaced wxPython with PySide6 + as of version 2.3rc1. Here is how to use the napari-aspects of the new GUI. It is available in napari-hub as a stand alone GUI as well as integrated into our main GUI.
