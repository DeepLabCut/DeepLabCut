    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
             init_kwargs=dict(
                 ...
                 name='ViT_alltopview_DEiT_pretrained')
             )
    ])
...
model = dict(
    type='TopDown',
    pretrained='/home/epfl_studenttemp/DeepLabCutv2/deeplabcut/cores/pose/notebook/deit_base_distilled_patch16_384-d0272ac0_.pth',
    backbone=dict(
    ...
    keypoint_head=dict(
        ...
        loss_keypoint=dict(type='JointsMSELoss', use_target_weight=True, gradient_masking = True)),
    train_cfg=dict(),
    test_cfg=dict(
        flip_test=False,
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='data/all_topview_bbox_AP70.json',
...
data_root = 'data/all_topview_70-D-O'
