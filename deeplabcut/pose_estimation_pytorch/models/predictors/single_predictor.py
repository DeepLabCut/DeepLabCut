...
class SinglePredictor(BasePredictor):
    ...
    def __init__(self, num_animals, location_refinement, locref_stdev, apply_sigmoid: bool= True):
        ...
        assert(self.num_animals == 1, "SinglePredictor must only be used for single animal predictions")
    ...
    def forward(self, output, scale_factors):
        ...
        poses = self.get_pose_prediction(heatmaps, locrefs*self.locref_stdev, scale_factors)
        return poses
