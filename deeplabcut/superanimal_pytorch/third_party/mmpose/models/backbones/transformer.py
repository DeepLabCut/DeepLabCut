...
class TokenPose_S(nn.Module):
    ...
    def __init__(self, IMAGE_SIZE,
                 PATCH_SIZE, NUM_JOINTS, DIM,
                 TRANSFORMER_DEPTH, TRANSFORMER_HEADS,
        ...
        self.features = TokenPose_S_base(image_size=IMAGE_SIZE,
...
class TokenPose_T(nn.Module):
    ...
    def __init__(self,
        ...
        self.transformer = TokenPose_TB_base(feature_size = [IMAGE_SIZE[1], IMAGE_SIZE[0]],
    ...
    def __init__(self, patch_size=16,
        ...
        if use_fpn:
            self.fpn1 = nn.Sequential(
                nn.ConvTranspose2d(embed_dim, embed_dim, kernel_size=6, stride=2, padding = 0),
                Norm2d(embed_dim),
                nn.GELU(),
