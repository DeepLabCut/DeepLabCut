...
These models are best for complex multi-animal or person pose estimation.

| Model Name                    | Type       | mAP SA-Q on AP-10K | mAP SA-TVM on DLC-OpenField |
|------------------------------|------------|---------------------|-----------------------------|
| ctd_coam_w32                 | Hybrid     |          |            |
| ctd_coam_w48                 | Hybrid     |          |            |
| ctd_prenet_hrnet_w32         | Hybrid     |          |            |
| ctd_prenet_hrnet_w48         | Hybrid     |          |            |
| ctd_prenet_rtmpose_s         | Hybrid     |          |            |
| ctd_prenet_rtmpose_m         | Hybrid     |          |            |
| ctd_prenet_rtmpose_x         | Hybrid     |          |            |
