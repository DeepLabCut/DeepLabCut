...
class CreateTrainingDataset(DefaultTab):
    def __init__(self, root, parent, h1_description):
        ...
        self.layout_attributes = _create_grid_layout(margins=(20, 0, 0, 0)) # todo here should get rid of this and do something like in tabs/create_project.py. Probably will do subwidgets (one for shuffle-related stuff, one for weight_init related stuff, etc)
