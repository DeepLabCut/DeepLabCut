...
**New:** as of ``pip install deeplabcut==2.0.7`` you can create a 3D project to combine multiple cameras for 3D pose estimation. Watch a [DEMO VIDEO](https://youtu.be/Eh6oIGE4dwI) on how to use this code!
