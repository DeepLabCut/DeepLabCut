...
def single_gpu_test(model, data_loader, save_for_mabe=False):
    ...
    def imagepath2videoname(image_path):
        image_path = image_path.split("/")[-1]
        video_name = image_path.split(".")[0].split("_")[0]
        return video_name

    video_name_count = defaultdict(int)
