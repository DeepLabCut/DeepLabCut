...
VIDS=['/home/alex/Dropbox/InterestingCode/social_datasets/4tanmay/silversideschooling-Valentina-2019-07-14/videos/deeplc.menidia.school4.59rpm.S11.D.short.avi']
config='/home/alex/Dropbox/InterestingCode/social_datasets/4tanmay/silversideschooling-Valentina-2019-07-14/config.yaml'
#config='/home/alex/Dropbox/InterestingCode/social_datasets/4tanmay/silversideschooling-Valentina-2019-07-14/config.yaml'
deeplabcut.extract_outlier_frames(config,VIDS,shuffle=0,outlieralgorithm='jump',epsilon=5,videotype='.avi')
