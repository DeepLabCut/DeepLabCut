...
from deeplabcut.pose_tracking_pytorch.tracking_utils import load_features_from_coord, convert_coord_from_img_space_to_feature_space, query_feature_by_coord_in_img_space
...
class DLCTrans:
    def __init__(self, checkpoint):
        ...
        self.model = build_dlc_transformer(ckpt_dict['num_kpts'])
