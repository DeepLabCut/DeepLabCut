...
for shuffle,net_type in enumerate(['mobilenet_v2_0.35','resnet_50']): #'mobilenet_v2_1.0']): # 'resnet_50']):
    ...
    if 'resnet_50'==net_type: #this tests the default condition...
        ...
        deeplabcut.create_training_dataset(path_config_file,Shuffles=[shuffle],net_type=net_type,augmenter_type=augmenter_type)
    ...
    deeplabcut.analyze_time_lapse_frames(path_config_file,os.path.join(cfg['project_path'],'labeled-data/reachingvideo1/'),shuffle=shuffle)
