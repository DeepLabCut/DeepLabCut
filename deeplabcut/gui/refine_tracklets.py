...
class Refine_tracklets(wx.Panel):
    ...
    def __init__(self, parent,gui_size,cfg):
        ...
        text = wx.StaticText(self, label="DeepLabCut - Refine tracklets")
        ...
        sizer.Add(self.sel_datafile, pos=(3, 1), span=(1, 3), flag=wx.TOP | wx.EXPAND, border=5)
        ...
        sizer.Add(self.sel_video, pos=(4, 1), span=(1, 3), flag=wx.TOP | wx.EXPAND, border=5)
